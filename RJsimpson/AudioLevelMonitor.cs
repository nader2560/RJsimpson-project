...
namespace RJsimpson
{
    public class AudioLevelMonitor
    {
        ...
        public AudioLevelMonitor(int processID)
        {
        ...
        {
            dispatchingTimer = new System.Timers.Timer(interval_ms);
            dispatchingTimer.Elapsed += DispatchingTimer_Elapsed2;
            dispatchingTimer.AutoReset = false;
            dispatchingTimer.Start();
        }
        public void Stop()
        ...
        private void DispatchingTimer_Elapsed2(object sender, System.Timers.ElapsedEventArgs e)
        {
        ...
        {
            this.CheckAudioLevels(processIDs);
            dispatchingTimer.Start(); // trigger next timer
        }
        ...
        public void CheckAudioLevels(int processID)
        {
            lock (this)
            {
                var seenPids = new HashSet<string>();
