...
namespace RJsimpson
{
    ...
    public static class AudioUtilities
    {
        ...
        public static IList<AudioDevice> GetAllDevices()
        {
            ...
            try
            {
                deviceEnumerator = (IMMDeviceEnumerator)(new CSCore.CoreAudioAPI.MMDeviceEnumerator());
            }
            catch
            {
            }
        ...
        private static IMMDevice GetSpeakers()
        {
            ...
            try
            {
                IMMDeviceEnumerator deviceEnumerator = (IMMDeviceEnumerator)(new CSCore.CoreAudioAPI.MMDeviceEnumerator());
                IMMDevice speakers;
